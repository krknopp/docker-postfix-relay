...
RUN apt-get install -qq -y --no-install-recommends postfix postfix-pcre ca-certificates libsasl2-modules python-pip supervisor
...
#ADD conf/postfix-virtual-regexp /etc/postfix/virtual-regexp
